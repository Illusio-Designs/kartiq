...
// Stock status from available quantity (matches the catalog's thresholds).
...
export default function InventoryPage() {
  ...
  // Global topbar + in-table search over the loaded page.
...
// One row with an inline "set stock" input. Writes an absolute on-hand value
// (type SET) — the intended flow for merchant-fulfilled sellers who own the
// number in Kartriq.
